...
public class AppConstant {
    ...
    public static final String TOKEN = "hyl_token";
    ...
    public static final String Hot = "hot";//热销
    public static final String Common = "common";//常购清单
    ...
    public static final String PAYCHANNAL = "paychannel";
