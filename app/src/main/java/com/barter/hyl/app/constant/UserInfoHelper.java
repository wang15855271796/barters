...
private static final String ISREGISTER ="is_register";
    ...
    public static String getIsregister(Context context) {
        if ((StringUtil.isBlank(PreferenceHelper.getData(context, USER_INFO, ISREGISTER)))) {
            return "";
        } else {
            try {
    ...
    public static String getLocationadress(Context context) {
        if ((StringUtil.isBlank(PreferenceHelper.getData(context, USER_INFO, LOCATIONADRESS)))) {
            return "";
        } else {
            try {
    ...
    public static String getProvince(Context context) {
        if ((StringUtil.isBlank(PreferenceHelper.getData(context, USER_INFO, PROVINCENAME)))) {
            return "";
        } else {
            try {
    ...
    public static String getCity(Context context) {
        if ((StringUtil.isBlank(PreferenceHelper.getData(context, USER_INFO, CITYNAME)))) {
            return "";
        } else {
            try {
    ...
    public static String getDeliverType(Context context) {
        if ((StringUtil.isBlank(PreferenceHelper.getData(context, USER_INFO, ORDERDELIVERYTYPE)))) {
            return "";
        } else {
            try {
    ...
    public static String getDriverid(Context context) {
        if ((StringUtil.isBlank(PreferenceHelper.getData(context, USER_INFO, DRIVERID)))) {
            return "";
        } else {
            try {
    ...
    public static String getLoadAmount(Context context) {
        if ((StringUtil.isBlank(PreferenceHelper.getData(context, USER_INFO, LOADAMOUNT)))) {
            return "";
        } else {
            try {
    ...
    public static String getRegistionid(Context context) {
        if ((StringUtil.isBlank(PreferenceHelper.getData(context, USER_INFO, REGISTIONID)))) {
            return "";
        } else {
            try {
    ...
    public static String getGuide(Context context) {
        if ((StringUtil.isBlank(PreferenceHelper.getData(context, USER_INFO, GUIDE)))) {
            return "";
        } else {
            try {
    ...
    public static String getRemark(Context context) {
        if ((StringUtil.isBlank(PreferenceHelper.getData(context, USER_INFO, REMARK)))) {
            return "";
        } else {
            try {
    ...
    public static String getOrderamount(Context context) {
        if ((StringUtil.isBlank(PreferenceHelper.getData(context, USER_INFO, ORDERAMOUNT)))) {
            return "";
        } else {
            try {
    ...
    public static String getForgetPas(Context context) {
        if ((StringUtil.isBlank(PreferenceHelper.getData(context, USER_INFO, FORGETPASSWORD)))) {
            return "";
        } else {
            try {
    ...
    public static String getUserMinute(Context context) {
        if ((StringUtil.isBlank(PreferenceHelper.getData(context, USER_INFO, USERMINUTE)))) {
            return "";
        } else {
            try {
    ...
    public static String getOrderId(Context context) {
        if ((StringUtil.isBlank(PreferenceHelper.getData(context, USER_INFO, ORDERID)))) {
            return "";
        } else {
            try {
    ...
    public static String getAreaName(Context context) {
        if ((StringUtil.isBlank(PreferenceHelper.getData(context, USER_INFO, AreaName)))) {
            return "";
        } else {
            try {
    ...
    //保存街道
    public static void saveStreet(Context context, String areaName) {
        try {
            PreferenceHelper.saveData(context, USER_INFO, Street, EncryptHelper.encrypt(AppConstant.APP_SHA_256, areaName));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public static String getStreet(Context context) {
        if ((StringUtil.isBlank(PreferenceHelper.getData(context, USER_INFO, Street)))) {
            return "";
        } else {
            try {
                return EncryptHelper.decrypt(AppConstant.APP_SHA_256, PreferenceHelper.getData(context, USER_INFO, Street));
            } catch (Exception e) {
                e.printStackTrace();
                return "";
            }
    ...
    public static String getChangeFlag(Context context) {
        if ((StringUtil.isBlank(PreferenceHelper.getData(context, USER_INFO, CHANGEFLAG)))) {
            return "";
        } else {
            try {
    ...
    public static String getDate(Context context) {
        if ((StringUtil.isBlank(PreferenceHelper.getData(context, USER_INFO, DATE)))) {
            return "";
        } else {
            try {
    ...
    public static String getWalletStatus(Context context) {
        if ((StringUtil.isBlank(PreferenceHelper.getData(context, USER_INFO, WALLETSTATUS)))) {
            return "";
        } else {
            try {
    ...
    public static String getSpikePosition(Context context) {
        if ((StringUtil.isBlank(PreferenceHelper.getData(context, USER_INFO, SPIKE_POSITION)))) {
            return "";
        } else {
            try {
    ...
    public static String getSpikeFlag(Context context) {
        if ((StringUtil.isBlank(PreferenceHelper.getData(context, USER_INFO, SPIKE_FLAG)))) {
            return "";
        } else {
            try {
    ...
    public static String getUserWalletNum(Context context) {
        if ((StringUtil.isBlank(PreferenceHelper.getData(context, USER_INFO, USER_WALLET_NUM)))) {
            return "";
        } else {
            try {
    ...
    public static String getUserWalletAccount(Context context) {
        if (StringUtil.isBlank(PreferenceHelper.getData(context, USER_INFO, USER_WALLET_ACCOUNT))) {
            return "";
        } else {
            try {
    ...
    public static String getUserCell(Context context) {
        if (StringUtil.isBlank(PreferenceHelper.getData(context, USER_INFO, USER_INFO_USER_CELL))) {
            return "";
        } else {
            try {
    ...
    public static String getUserIsFirst(Context context) {
        if (StringUtil.isBlank(PreferenceHelper.getData(context, USER_INFO, USER_INFO_IS_FIRST))) {
            return "";
        } else {
            try {
    ...
    public static String getUserId(Context context) {
        if (StringUtil.isBlank(PreferenceHelper.getData(context, USER_INFO, USER_INFO_USER_ID))) {
            return "";
        } else {
            try {
    ...
    public static String getUserTel(Context context) {
        if (StringUtil.isBlank(PreferenceHelper.getData(context, USER_INFO, USER_TEL))) {
            return "";
        } else {
            try {
    ...
    public static String getUserSearchHistory(Context context) {
        if (StringUtil.isBlank(PreferenceHelper.getData(context, USER_INFO, USER_SEARCH_HISTORY))) {
            return "";
        } else {
            try {
    ...
    public static String getUserSearchContent(Context context) {
        if (StringUtil.isBlank(PreferenceHelper.getData(context, USER_INFO, USER_SEARCH_CONTENT))) {
            return "";
        } else {
            try {
    ...
    public static String getUserType(Context context) {
        if (StringUtil.isBlank(PreferenceHelper.getData(context, USER_INFO, USER_TYPE))) {
            return "";
        } else {
            try {
    ...
    public static String getUserHomeRefresh(Context context) {
        if (StringUtil.isBlank(PreferenceHelper.getData(context, USER_INFO, USER_LOGIN_HOME_REFRESH))) {
            return "";
        } else {
            try {
    ...
    public static String getUserMarketRefresh(Context context) {
        if (StringUtil.isBlank(PreferenceHelper.getData(context, USER_INFO, USER_LOGIN_MARKET_REFRESH))) {
            return "";
        } else {
            try {
