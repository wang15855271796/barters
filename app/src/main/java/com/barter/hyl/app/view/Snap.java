...
public class Snap extends LinearLayout {
    ...
    public Snap.Timeout timeout;

    public Snap.Timeout getTimeout() {
        return timeout;
    }

    public void setTimeout(Snap.Timeout timeout) {
    ...
    public Snap(Context context, AttributeSet attrs) {
        ...
        View view = inflater.inflate(R.layout.view_countdowntimer_hyl, this);
...
//            AppHelper.showMsg(context, "时间格式错误");
    ...
    public void setTime(boolean isShow, boolean isFrom,long nowTime, long startTime, long endTime) {
...
//        ll_sec_bg.setBackgroundColor(color);
        ...
        tv_hour_decade.setTextColor(Color.parseColor("#FF1D29"));
        tv_hour_unit.setTextColor(Color.parseColor("#FF1D29"));
        tv_min_decade.setTextColor(Color.parseColor("#FF1D29"));
        tv_min_unit.setTextColor(Color.parseColor("#FF1D29"));
        tv_sec_decade.setTextColor(Color.parseColor("#FF1D29"));
        tv_sec_unit.setTextColor(Color.parseColor("#FF1D29"));
        tv_hour.setTextColor(Color.parseColor("#FF1D29"));
        tv_min.setTextColor(Color.parseColor("#FF1D29"));
