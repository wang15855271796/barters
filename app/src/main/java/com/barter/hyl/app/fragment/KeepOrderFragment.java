 ...
 */
public class KeepOrderFragment extends BaseFragment implements View.OnClickListener {
...
//        getMyOrderList();
        ...
        if(orderDeliveryType==0) {
            hylMyOrderListAdapter = new HylMyOrderListAdapter(R.layout.item_my_order_hyl, list, isCheck,16, orderDeliveryType, new HylMyOrderListAdapter.OnClick() {
                @Override
