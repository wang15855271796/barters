...
//    @BindView(R.id.ptr_my_orders)
//    PtrClassicFrameLayout mPtr;
//    @BindView(R.id.rl_over_order)
//    RelativeLayout rl_over_order;
//    @BindView(R.id.iv_no_data)
//    ImageView iv_no_data;
//    @BindView(R.id.tv_pay)
//    TextView tv_pay;
...
//    @Override
//    public int setLayoutId() {
//        return R.layout.fragment_my_overdueorders;
//    }
//
//    @Override
//    public void onResume() {
...
//
//                    @Override
//                    public void onNext(HylLoginModel loginModel) {
//                        if (loginModel.code==1) {
//                            if(loginModel.data!=null) {
//                                EventBus.getDefault().post(new CartNumHylEvent());
//                                EventBus.getDefault().post(new CartListHylEvent());
//                                ToastUtil.showSuccessMsg(mActivity,loginModel.data);
//                            }
//                        }else {
//                            ToastUtil.showSuccessMsg(mActivity, loginModel.message);
//                        }
//                    }
//                });
//    }
...
//
//                    @Override
//                    public void onNext(HylMyOrderListModel myOrderListModel) {
//                        if (myOrderListModel.getCode()==1) {
//                            if(myOrderListModel.getData()!=null) {
//                                mPtr.refreshComplete();
//                                hylMyOrderListModels = myOrderListModel;
////                                list.addAll(myOrderListModel.getData().getList());
////                                hylMyOrderListAdapter.notifyDataSetChanged();
//                                if(hylMyOrderListModels.getData().getList().size()>0) {
//                                    rl_over_order.setVisibility(View.VISIBLE);
//                                }else {
//                                    rl_over_order.setVisibility(View.GONE);
//                                }
//
//                                isCheck.clear();
//                                for (int i = 0; i < list.size(); i++) {
//                                    isCheck.put(i, false);
//                                }
////                                if (myOrderListModel.getData().isHasNextPage()) {
////                                    //有下一页数据
////                                    hylMyOrderListAdapter.loadMoreComplete();
////                                } else {
////                                    //没有下一页数据了
...
//                            }
//                        }else {
//                            ToastUtil.showSuccessMsg(mActivity, myOrderListModel.getMessage());
//                        }
//                    }
//                });
//    }
...
//
//    @Subscribe(threadMode = ThreadMode.MAIN)
//    public void getAmount(TotalAmountHylEvent totalAmountEvent) {
//        totalAmounts = totalAmountEvent.getAllPrice();
//        tv_total_amount.setText(totalAmountEvent.getAllPrice());
//        ids = totalAmountEvent.getIds();
//    }
//
//    List<HylMyOrderListModel.DataBean.ListBean> data = new ArrayList<>();
//    @Subscribe(threadMode = ThreadMode.MAIN)
