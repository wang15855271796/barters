 ...
 */
public class HylShopImageViewAdapter extends RecyclerView.Adapter<HylShopImageViewAdapter.ViewHolder>{
    ...
    public HylShopImageViewAdapter(Context context, onAddPicClickListener mOnAddPicClickListener) {
        ...
        if (getItemViewType(position) == TYPE_CAMERA) {
            ...
            viewHolder.mImg.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    mOnAddPicClickListener.onAddPicClick(position);
                }
            });
