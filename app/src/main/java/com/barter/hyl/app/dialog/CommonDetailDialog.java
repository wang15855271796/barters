...
public class CommonDetailDialog extends Dialog implements View.OnClickListener {
    ...
    HylCommonDetailModel.DataBean listBean;
    int pos;
    public CommonDetailDialog(Activity mActivity, HylCommonDetailModel.DataBean listBean, int position) {
                ...
                .subscribe(new Subscriber<HylAddCartModel>() {
                    ...
                    public void onNext(HylAddCartModel hylAddCartModel) {
                        if (hylAddCartModel.getCode()==1) {
                            ...
                            productId = data.getSpecs().get(pos).getProductId();
