 ...
 */
public class HylPaymentOrderFragment extends BaseFragment {
...
//        getMyOrderList();
        ...
        hylMyOrderListAdapter = new HylMyOrderListAdapter(R.layout.item_my_order_hyl, list, isCheck,1, orderDeliveryType, new HylMyOrderListAdapter.OnClick() {
            @Override
            ...
            public void imageGo(String orderId, String totalAmount,int orderType,String id) {
                payOrder(orderId,totalAmount,orderType);
            }
     ...
     * @param totalAmount
     */
    private void payOrder(String orderId,String totalAmount,int orderType) {
