...
import com.barter.hyl.app.adapter.HylMyCouponsUsedAdapter;
 ...
 * 我的优惠券界面已使用
 */
public class HylCouponsUseFragment extends BaseFragment {

    private HylMyCouponsUsedAdapter adapter;
    ...
    public void setViewData() {
        ...
        adapter = new HylMyCouponsUsedAdapter(R.layout.item_my_coupons_hyl,lists,getActivity());
    ...
    private void requestMyCoupons() {
        MyInfoApi.getMyCouponList(getActivity(), pageNum, 10,"USED")
