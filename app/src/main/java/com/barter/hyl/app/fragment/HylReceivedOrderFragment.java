 ...
 */
public class HylReceivedOrderFragment extends BaseFragment {
...
//        getMyOrderList();
        ...
        hylMyOrderListAdapter = new HylMyOrderListAdapter(R.layout.item_my_order_hyl, list, isCheck,3, orderDeliveryType, new HylMyOrderListAdapter.OnClick() {
            @Override
