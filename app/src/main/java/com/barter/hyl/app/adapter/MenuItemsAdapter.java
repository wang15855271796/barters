...
public class MenuItemsAdapter extends BaseAdapter {
    ...
    //菜单列表
    private List<HylAreaModel.DataBean> mListData;
    ...
    public MenuItemsAdapter(Context context, List<HylAreaModel.DataBean> listData, int sId, int nId) {
        mContext = context;
        mListData = listData;
     ...
     */
    public void setSelectedPositionNoNotify(int pos,List<HylAreaModel.DataBean> list) {
        selectedPos = pos;
        mListData = list;
        if (mListData != null && pos < mListData.size()) {
            selectedText = mListData.get(pos).getProvinceName();
