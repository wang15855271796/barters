...
public class HylMyOrdersViewPagerAdapter extends FragmentPagerAdapter {
    private List<String> mTitleList;
    private List<BaseFragment> mFragmentList;
    private FragmentManager mFragmentManager;

    private FragmentTransaction mCurTransaction;
    public HylMyOrdersViewPagerAdapter(FragmentManager fm, List<String> mTitleList, List<BaseFragment> mFragmentList) {
        super(fm);
