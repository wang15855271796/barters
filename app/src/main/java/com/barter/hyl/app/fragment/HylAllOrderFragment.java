 ...
 */
public class HylAllOrderFragment extends BaseFragment {
    ...
    public void setViewData() {
        ...
        if(orderDeliveryType==0) {
            hylMyOrderListAdapter = new HylMyOrderListAdapter(R.layout.item_my_order_hyl, list, isCheck,0, orderDeliveryType, new HylMyOrderListAdapter.OnClick() {
                @Override
