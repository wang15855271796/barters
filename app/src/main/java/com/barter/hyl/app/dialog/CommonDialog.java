...
public class CommonDialog extends Dialog implements View.OnClickListener {
    ...
    HylActiviteModel.DataBean.ListBean listBean;
    public CommonDialog(Activity mActivity, HylActiviteModel.DataBean.ListBean listBean) {
