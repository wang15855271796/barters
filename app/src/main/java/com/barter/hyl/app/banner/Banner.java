...
import com.barter.hyl.app.banner.listener.OnBannerClickListener;
import com.barter.hyl.app.banner.listener.OnBannerListener;
import com.barter.hyl.app.banner.loader.ImageLoaderInterface;
import com.barter.hyl.app.banner.view.BannerViewPager;
...
public class Banner extends FrameLayout implements OnPageChangeListener {
    ...
    private void setImageList(List<?> imagesUrl) {
        if (imagesUrl == null || imagesUrl.size() <= 0) {
            ...
            Log.e("sssdwdwdwdd", "The image data set is empty.");
            return;
        }
