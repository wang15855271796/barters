 ...
 */
public class HylDeliveryOrderFragment extends BaseFragment {
...
//        getMyOrderList();
        ...
        hylMyOrderListAdapter = new HylMyOrderListAdapter(R.layout.item_my_order_hyl, list, isCheck,2, orderDeliveryType, new HylMyOrderListAdapter.OnClick() {
            @Override
