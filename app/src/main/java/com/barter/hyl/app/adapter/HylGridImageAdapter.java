 ...
 * data：16/7/27
 */
public class HylGridImageAdapter extends
        RecyclerView.Adapter<HylGridImageAdapter.ViewHolder>{
    ...
    public HylGridImageAdapter(Context context, onAddPicClickListener mOnAddPicClickListener) {
