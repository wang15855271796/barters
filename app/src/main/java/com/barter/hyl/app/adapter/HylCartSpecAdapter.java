 ...
 */
public class HylCartSpecAdapter extends BaseQuickAdapter<HylCartListModel.DataBean.ProdsBeanX,BaseViewHolder> {
    public HylCartSpecAdapter(int layoutResId, @Nullable List<HylCartListModel.DataBean.ProdsBeanX> data) {
