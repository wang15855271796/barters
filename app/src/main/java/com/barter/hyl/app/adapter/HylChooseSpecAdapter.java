 ...
 */
public class HylChooseSpecAdapter extends BaseAdapter {

    Context context;
    List<HylCommonDetailModel.DataBean.SpecsBean> prodSpecs;
    int selectPosition;
    Onclick onclick;
    public HylChooseSpecAdapter(Context context, List<HylCommonDetailModel.DataBean.SpecsBean> prodSpecs, Onclick onclick) {
