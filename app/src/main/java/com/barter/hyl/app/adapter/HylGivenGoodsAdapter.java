 ...
 */
public class HylGivenGoodsAdapter extends BaseQuickAdapter<HylCartListModel.DataBean.ProdsBeanX,BaseViewHolder> {
    public HylGivenGoodsAdapter(int layoutResId, @Nullable List<HylCartListModel.DataBean.ProdsBeanX> data) {
        super(layoutResId, data);
    }

    @Override
    protected void convert(BaseViewHolder helper, HylCartListModel.DataBean.ProdsBeanX item) {
