 ...
 */
public class HylMyCouponsUsedAdapter extends BaseQuickAdapter<HylMyCouponModel.DataBean.ListBean,BaseViewHolder> {
    ...
    TextView tv_tip;
    public HylMyCouponsUsedAdapter(int layoutResId, @Nullable List<HylMyCouponModel.DataBean.ListBean> data, Context context) {
