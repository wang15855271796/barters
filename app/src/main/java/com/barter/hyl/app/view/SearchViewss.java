...
public class SearchViewss extends LinearLayout implements View.OnClickListener {
    ...
    public SearchViewss(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        LayoutInflater.from(context).inflate(R.layout.search_layoutss, this);
        initViews();
    }
    ...
    private void initViews() {
        ...
        etInput.addTextChangedListener(new SearchViewss.EditChangedListener());
