...
/**
 * Created by ${王涛} on 2021/9/7(待审核)
 */
public class HylCheckOrderFragment extends BaseFragment {
...
//        getMyOrderList();
        ...
        hylMyOrderListAdapter = new HylMyOrderListAdapter(R.layout.item_my_order_hyl, list, isCheck,15, orderDeliveryType, new HylMyOrderListAdapter.OnClick() {
            @Override
