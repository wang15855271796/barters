 ...
 */
public class HylCommonFragment extends BaseFragment {
    ...
    int pageSize = 10;
    View emptyView;
    public static HylCommonFragment getInstance() {
        HylCommonFragment fragment = new HylCommonFragment();
        return fragment;
    }
    ...
    private void getCommon() {
        HomeApi.getCommon(mActivity,pageNum,pageSize)
