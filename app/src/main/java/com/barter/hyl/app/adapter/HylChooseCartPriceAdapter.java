 ...
 */
public class HylChooseCartPriceAdapter extends BaseQuickAdapter<HylCartListModel.DataBean.InValidProdBean.ProdsBean,BaseViewHolder> {
    public HylChooseCartPriceAdapter(int layoutResId, @Nullable List<HylCartListModel.DataBean.InValidProdBean.ProdsBean> data) {
        super(layoutResId, data);
    }

    @Override
    protected void convert(BaseViewHolder helper, HylCartListModel.DataBean.InValidProdBean.ProdsBean item) {
