...
public class MenuSecondItemAdapter extends BaseAdapter {
    ...
    //菜单列表
    private List<HylAreaModel.DataBean.CityListBean> mListData;
    ...
    public MenuSecondItemAdapter(Context context, List<HylAreaModel.DataBean.CityListBean> listData, int sId, int nId) {
        mContext = context;
        mListData = listData;
     ...
     */
    public void setSelectedPositionNoNotify(int pos,List<HylAreaModel.DataBean.CityListBean> list) {
        selectedPos = pos;
        mListData = list;
        if (mListData != null && pos < mListData.size()) {
            selectedText = mListData.get(pos).getCityName();
